...
class EditProductScreen extends StatefulWidget {
  EditProductScreen(this.productData, {Key? key}) : super(key: key);
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  Widget build(BuildContext context) {
    nameController.text = widget.productData['name'].toString() == 'null'
        ? ''
        : widget.productData['name'].toString();
    quantityController.text =
        widget.productData['quantity'].toString() == 'null'
            ? ''
            : widget.productData['quantity'].toString();
    phoneController.text =
        widget.productData['phone_number'].toString() == 'null'
            ? ''
            : widget.productData['phone_number'].toString();
    facebookController.text =
        widget.productData['facebook_url'].toString() == 'null'
            ? ''
            : widget.productData['facebook_url'].toString();

    return Scaffold(
      appBar: myAppbar('Edit Product'.tr(), Icons.edit),
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child:
            ...
            Provider.of<AddProductProvider>(context, listen: false)
                .setCategoryValue(widget.productData['category']);
            return Column(
              children: [
                const SizedBox(
                  height: 20,
                ...
                AnimatedContainer(
                  ...
                  child: addProduct.mytextfield(
                      ...
                      Icons.phone,
                      // addProduct.phoneContainerHeight == 0 ? 0 :
                      2,
                      phoneController),
                ),
                AnimatedContainer(
                  ...
                  child: addProduct.mytextfield(
                      ...
                      TextInputType.url,
                      Icons.link,
                      //addProduct.facebookContainerHeight == 0 ? 0 :
                      2,
                      facebookController),
                ),
                addProduct.mytextfield(
